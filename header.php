                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            <li><a href="" data-toggle="modal" data-target="#Modal_register"><i class="fa fa-sign-in" aria-hidden="true" ></i>Register</a></li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/os.png" class="logo" alt=""></a>
                </div>
